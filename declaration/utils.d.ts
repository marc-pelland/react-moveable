...
export declare function caculateMatrixStack(target: SVGElement | HTMLElement, container: SVGElement | HTMLElement | null, rootContainer: SVGElement | HTMLElement | null, prevMatrix?: number[], prevRootMatrix?: number[], prevN?: number): [number[], number[], number[], number[], number[], string, number[], boolean];
...
export declare function getTargetInfo(target?: HTMLElement | SVGElement, container?: HTMLElement | SVGElement | null, parentContainer?: HTMLElement | SVGElement | null, rootContainer?: HTMLElement | SVGElement | null, state?: Partial<MoveableManagerState> | false | undefined): Partial<MoveableManagerState>;
...
export declare function triggerEvent<T extends IObject<any>, U extends keyof T>(moveable: MoveableManager<T>, name: U & string, params: T[U] extends ((e: infer P) => any) | undefined ? P : {}, isManager?: boolean): any;
export declare function getComputedStyle(el: HTMLElement | SVGElement, pseudoElt?: string | null): CSSStyleDeclaration;
export declare function filterAbles(ables: Able[], methods: Array<keyof Able>, triggerAblesSimultaneously?: boolean): Able<any>[];
